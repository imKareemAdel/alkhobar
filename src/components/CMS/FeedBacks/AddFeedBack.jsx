...
const AddFeedBack = ({ handleMenuClick }) => {
    ...
    <div className='h-screen relative bg-[#FEFEFE] shadow m-8'>
        ...
        <div className='flex justify-around items-start mx-2'>
            <div className='w-[584px]'>
                <div className='mt-7'>
                    <h1 className='text-[18px] text-[#254574] ms-1'>
                        أسم العميل <span className='text-[#F88630]'>*</span>
                    </h1>
                ...
                <div className='mt-7'>
                    <h1 className='text-[18px] text-[#254574] ms-1'>
                        القسم<span className='text-[#F88630]'>*</span>
                    </h1>
                    <div className='w-full h-[56px] bg-[#F2F2F2] flex justify-start items-center mt-2 ps-3 text-[16px] rounded-md'>
                        <input
                            type="text"
            ...
            <div className='w-[584px]'>
                ...
                <div className='mt-7'>
                    <h1 className='text-[18px] text-[#254574] ms-1'>
                        محتوى التعليق<span className='text-[#F88630]'>*</span>
                    </h1>
                    <div className='w-full h-[112px] bg-[#F2F2F2] flex justify-start items-start mt-2 ps-3 text-[16px] rounded-md'>
                        <textarea
                            placeholder="أدخل محتوى التعليق"
                            className="bg-[#F2F2F2] w-full h-full rounded-md pt-3 resize-none border-none focus:outline-none focus:ring-0"
                            style={{ boxShadow: 'none' }}
                        />
                    </div>
                </div>
        ...
        <div className='absolute bottom-3 left-2 flex space-x-4'>
            <button className='bg-[#2A4E84] text-white w-[285px] h-[56px] flex justify-center items-center rounded-md me-3'>إضافة</button>
