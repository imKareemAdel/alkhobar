...
const CourseTable = ({ handleMenuClick, activeContent, children }) => {
  return (
        ...
        <table className="w-full text-center  rtl:text-right text-gray-500 text-[18px] mb-10">
          ...
          <tbody>
            {/* <tr className="odd:bg-[#F6FAFF]  even:bg-white  text-center border-gray-200">
              ...
              <td className="px-6 py-4">الدبلومات التدريبة</td>
              <td className="px-6 py-4">4 دورات</td>
              <td className="px-6 py-4 text-lg">
                <i className="fa-solid fa-eye me-1"></i>{" "}
                <i
                  className="fa-regular fa-pen-to-square me-1"
                  onClick={() => handleMenuClick("تعديل الدورة")}
                ></i>{" "}
                <i className="fa-solid fa-trash-can text-[#CA152A] me-1"></i>
              </td>
            </tr>
